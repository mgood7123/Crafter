...
public class MagnumEGLSurfaceView extends EGLSurfaceView {
    MagnumRenderer renderer;

    public MagnumEGLSurfaceView(Context context) {
        super(context);
    }

    public MagnumEGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private class MagnumRenderer implements Renderer {
        ...
        public void onEglSetup() {
            onEglSetup(nativeInstance, MagnumEGLSurfaceView.this,
